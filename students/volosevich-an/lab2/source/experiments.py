...
# %% [markdown]
# ## KNN k = 5 с фиксированным размером окна
...
# %% [markdown]
# ## KNN k = 5 с динамическим размером окна
...
# %% [markdown]
# ## Эталонная реализация KNeighborsClassifier
...
# %% [markdown]
# ## Оценка эмпирического риска при разных k
