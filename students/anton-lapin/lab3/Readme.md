...
# Результаты
Точность идентична с sikit-learn
Количество опорных веткоров отличается на 3. То есть сам алгоритм близок, но не идентичен
Правильные нелинейные границы для круговых данных
