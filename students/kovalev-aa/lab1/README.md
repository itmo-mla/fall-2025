...
### Диаграмма классов
![Диаграмма классов](source/img/diagram.png)
...
График эмпирического риска(каждые 10% эпох)
![График ошибки](source/img/emp_losses.png)
График отклонений
![График отклонений](source/img/margin.png)
Показатели лучшей модели
![Результаты лучшей модели](source/img/results.png)
Сравнение с не стохастическим градиентным спуском

![Результаты лучшей модели](source/img/results_compare_with_gd.png)
