...
3.  **Сравнение классификаторов**:
    ...
    **Вывод**: Использование сокращенного набора эталонов (Prototype KNN) привело к незначительному снижению Accuracy (~1.2%) по сравнению с использованием полной выборки, при этом значительно ускорив процесс классификации (меньше расстояний для вычисления). Интересно отметить, что точность (Precision) у метода на эталонах оказалась даже выше, чем у классификатора на полных данных, что говорит об успешном удалении шумовых объектов граничных классов.
