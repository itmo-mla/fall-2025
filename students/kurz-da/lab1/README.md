...
![История потерь базового классификатора](images/Базовый классификатор.png)

Инициализация весов через корреляцию:
![История потерь с корреляционной инициализацией](images/Инициализация через корреляцию.png)

Случайная инициализация весов + мультистарт:
![Результат мультистарта](images/случайная через мультистарт.png)

Случайное предъявление объектов:
![Случайное предъявление](images/случайное предъявление.png)

Предъявление по модулю отступа:
![Выборка по модулю отступа](images/модуль отступа.png)

Стохастический градиентный спуск с инерцией:
![SGD с инерцией](images/стохастический с инерцией.png)

Предъявление по модулю отступа без стохастичности
![По модулю без стохастичности](images/по модулю без стохастичности.png)
...
![Сравнение с Sklearn](images/сравнение с sklearn.png)
