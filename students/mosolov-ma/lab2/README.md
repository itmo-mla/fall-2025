...
На [графике прототипов в пространстве PCA](prototypes.jpg) отображены обучающие данные (круги), прототипы (треугольники) и тестовая выборка (квадраты), демонстрируя разделимость классов.
