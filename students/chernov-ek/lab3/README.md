...
1. Выбран датасет []() для бинарной классификации.
2. Реализовано решение двойственной задачи по лямбда.
...
3. Реализовали kernel trick.

![Kernel tricks](assets/KT.png)

4. Реализация линейного классификатора.
