...
![Визуализация работы алгоритма отбора эталонов](assets/k_clusters.png)
...
Для KNN с отбором эталонов с помощью KMeans кластеризации, где k=5, n_clusters=20:

![KNN с отбором эталонов](assets/k5_c20.png)
