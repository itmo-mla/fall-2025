...
На графике риска видно плато с k=3 до k=30, после чего значение ошибки снижается, остается неизменным до k=90, затем растет
...
### Отбор эталонов
Был реализован жадный отбор эталонов по критерию CCV. После применения алгоритма количество объектов в датасете сократилось с 124 до 118
